    ...
    <>
      ...
      <div className="space-y-5">
        {balanceRow?.status === 'PENDING' && !balanceRow.emailVerifiedAt ? (
          ...
          >
            لینک تایید به ایمیل شما ارسال شده است؛ اگر آن را در صندوق ورودی نمی‌بینید، پوشه اسپم (Spam) را هم بررسی
            کنید. تا زمانی که ایمیل حساب تایید نشود، امکان ساخت سرور وجود ندارد.
          </Alert>
        ) : null}
